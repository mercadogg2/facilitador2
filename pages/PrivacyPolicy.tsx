        ...
        <div className="prose prose-blue max-w-none space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-4">
              <li><strong>Dados de Perfil:</strong> Nome, email, telefone e localização fornecidos durante o registo.</li>
              ...
              <li><strong>Dados de Veículos:</strong> Para stands, recolhemos detalhes técnicos e imagens dos automóveis anunciados.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-4">
              ...
              <li>Enviar comunicações de marketing e newsletters (apenas com o seu consentimento).</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              O Facilitador Car não vende os seus dados a terceiros. A partilha de informação ocorre exclusivamente para viabilizar o negócio: os dados de um "Lead" (nome, telefone, email) são partilhados apenas com o Stand específico que detém o anúncio pelo qual demonstrou interesse.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Em conformidade com o RGPD (Europa) e LGPD (Brasil), tem o direito de aceder, retificar, exportar ou solicitar a eliminação dos seus dados pessoais a qualquer momento através das definições do seu perfil ou contactando o nosso suporte.
            </p>
          </section>
        </div>
      </div>
