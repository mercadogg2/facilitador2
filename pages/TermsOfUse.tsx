      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="prose prose-blue max-w-none space-y-8 text-gray-700 leading-relaxed">
          <section>
            ...
            <p>
              Ao aceder e utilizar a plataforma Facilitador Car, o utilizador concorda em cumprir estes Termos de Uso. Se não concordar com qualquer parte destes termos, não deverá utilizar os nossos serviços.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              O Facilitador Car é um marketplace que facilita a ligação entre potenciais compradores e stands profissionais. O Facilitador Car não é proprietário dos veículos anunciados, não atua como vendedor direto e não se responsabiliza pela conclusão física do negócio ou pelo estado mecânico dos veículos.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-4">
              ...
              <li><strong>Veracidade:</strong> Todas as informações dos anúncios (preço, km, extras) devem ser verídicas e atualizadas.</li>
          ...
          <section>
            ...
            <p>
              Todo o conteúdo da plataforma (logos, design, código e textos originais) é propriedade do Facilitador Car. As imagens dos veículos são propriedade dos respetivos stands ou fotógrafos autorizados.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Reservamos o direito de modificar estes termos a qualquer momento. Alterações significativas serão notificadas através da plataforma ou via email.
            </p>
          </section>
        </div>
      </div>
